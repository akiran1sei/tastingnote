      ...
      <div className={styles.edit_contents}>
        <form onSubmit={handleSubmit}>
          <table className={styles.edit_table}>
            <thead className={styles.edit_table_thead}>
              <tr className={styles.edit_table_row}>
                <th className={styles.edit_table_header_item}>Item</th>
                <th className={styles.edit_table_header_value}>Value</th>
              </tr>
            </thead>
            <tbody className={styles.edit_table_tbody}>
              <tr className={styles.edit_table_row}>
                <td className={styles.edit_table_data_header}>Date</td>
                <td className={styles.edit_table_data}>{date}</td>
              </tr>
              <tr className={styles.edit_table_row}>
                <td className={styles.edit_table_data_header}>
                  <label htmlFor="group-name">Group</label>
                </td>
                <td className={styles.edit_table_data}>
                  <select
                    name="group-name"
                    id="group-name"
                    value={groupName}
              ...
              <tr className={styles.edit_table_row}>
                ...
                <td className={styles.edit_table_data}>
                  <table border="0" className={styles.table_aroma}>
                    <thead>
                      <tr
                        className={`${styles.edit_table_row} ${styles.table_aroma_row}`}
                      >
                        <th
                          className={`${styles.edit_table_header} ${styles.table_aroma_data_header}`}
                        ></th>
                        <th
                          className={`${styles.edit_table_header} ${styles.table_aroma_data_header}`}
                        >
                    ...
                    <tbody>
                      ...
                      >
                        <td
                          className={`${styles.edit_table_data} ${styles.table_aroma_data}`}
                        >
                          <label>Dry</label>
                        </td>
                        <td
              ...
              <tr className={styles.edit_table_row}>
                <td className={styles.edit_table_data_header}>Impression</td>
                <td className={styles.edit_table_data}>
                  <textarea
